...
class TimeflakeTest {
	...
	void max() {
		...
		assertThat(timeflake).isEqualTo(Timeflake.of(Timeflake.MAX_VALUE));
	...
	@Test
	void create() {
		final Timeflake timeflake = Timeflake.create(1579091935216L, new BigInteger("724773312193627487660233"));
		assertThat(timeflake.value()).isEqualTo(new BigInteger("1909005012028578488143182045514754249"));
